...
// NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule checks ...
type NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule struct {
	tflint.DefaultRule
...
// NewNrNrqlAlertConditionInvalidBaselineCriticalOperatorRule returns new rule with default attributes
func NewNrNrqlAlertConditionInvalidBaselineCriticalOperatorRule() *NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule {
	return &NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule{
...
func (r *NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule) Name() string {
	return "nr_nrql_alert_condition_invalid_baseline_critical_operator"
}

// Enabled returns whether the rule is enabled by default
func (r *NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule) Enabled() bool {
	// TODO: Determine whether the rule is enabled by default
	return true
}

// Severity returns the rule severity
func (r *NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule) Severity() tflint.Severity {
	// TODO: Determine the rule's severiry
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule) Link() string {
...
// Check checks ...
func (r *NrNrqlAlertConditionInvalidBaselineCriticalOperatorRule) Check(runner tflint.Runner) error {
	...
	for _, resource := range resources.Blocks {
		...
		if strings.ToLower(typeValue) == "baseline" {
			for _, block := range resource.Body.Blocks {
				...
				if strings.ToLower(operatorValue) != "above" {
